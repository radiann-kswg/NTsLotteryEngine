...
| --- | --- | --- |
| 塔 | 5.1 / 3.2 | **17.3 / 11.1** |
| コースター | 8.1 / 5.4 | **26.5 / 19.2** |

- まだ M3（avg 30 / min 20）には届かない。残りは**塔の透明筒（Glass・α0.10）の重ね描き**が濃厚で、
  塔がコースターより 1.5 倍遅いのもここ。次の手は「Watch 中だけガラスを間引く」か「renderScale をさらに下げる（ぼけと引き換え）」。
